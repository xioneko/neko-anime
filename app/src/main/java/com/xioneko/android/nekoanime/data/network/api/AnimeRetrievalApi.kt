...
/**
 * API示例:
 * - 搜索：https://www.yhpdm.net/s_all?ex=1&kw=女神的露天咖啡厅
 * - 信息页：https://www.yhpdm.net/showp/22415.html
 * - 检索: https:/ww.yhpdm.net/list/?region=日本&genre=TV&year=2022&season:=4&status=完结&label=运动&order=名称
 */
